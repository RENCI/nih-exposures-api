...
class cmaq_db:
    ...
    def __init__(self):
        ...
        self.db_settings = self.config['exposures-db']
        self.host = str(self.db_settings['host'])
        self.port = str(self.db_settings['port'])
        self.user = str(self.db_settings['user'])
        self.password = str(self.db_settings['pswd'])
        self.dbname = str(self.db_settings['name'])
        self.table_name = str(self.db_settings['table-name'])
...
# connect to DB and create cmaq data table
db = cmaq_db()
cur = db.connect()
...
# now get cmaq data and populate db table
